// Packet — standalone React component, exported from the Search Field Gallery.
// Colours, typography and timings below are the gallery's live settings at the
// moment you copied this. No dependencies. MIT.
// Drift speed 1.00 · band width 1.00 — both live below.
...
export default function Packet({
  ...
  fill="var(--token-92ad8f0d-602f-4238-959e-9119bc61089d, rgb(250, 250, 250))", border="var(--token-92ad8f0d-602f-4238-959e-9119bc61089d, rgb(250, 250, 250))",
  ...
  const burst=useBorderLight(cv,{on:text.length===0,w,h:height,radius,pad,
  ...
  return(
    <div ref={host} style={{position:"relative",width:"100%",margin:(-pad)+"px 0"}}>
      <div style={{position:"relative",padding:pad}}>
        <canvas ref={cv} style={{position:"absolute",left:0,top:0,width:w,height:height+pad*2,pointerEvents:"none"}}/>
